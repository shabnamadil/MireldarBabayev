...
class TestAboutUsPageSeoModelIntegration(BaseValidationTest, _ImageValidationTest):
    @classmethod
    ...
    def test_og_image_saved_correctly(self):
        self.assertTrue(self.object.og_image.name.startswith('seo-images/about-us/'))
