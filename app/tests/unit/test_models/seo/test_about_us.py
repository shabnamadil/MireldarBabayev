...
class TestAboutUsPageSeoModel(BaseSeoTest):
    ...
    def test_image_field(self):
        self.assertTrue(self.instance.og_image.name.startswith("seo-images/about-us/"))
    ...
    def test_model(self):
        self.assert_model_instance(AboutUsPageSeo, 'meta_title', self.valid_data["meta_title"])
        self.assert_model_instance(AboutUsPageSeo, 'meta_description', self.valid_data["meta_description"])
        self.assert_model_instance(AboutUsPageSeo, 'meta_keywords', self.valid_data["meta_keywords"])
        self.assert_model_instance(AboutUsPageSeo, 'og_title', self.valid_data["og_title"])
        self.assert_model_instance(AboutUsPageSeo, 'og_description', self.valid_data["og_description"])
        self.assertTrue(self.instance.og_image.name.startswith('seo-images/about-us/'))
