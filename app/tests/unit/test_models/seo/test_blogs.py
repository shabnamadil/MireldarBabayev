...
class TestBlogsPageSeoModel(BaseSeoTest):

    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.instance = BlogsPageSeo.objects.create(**cls.valid_data)
    ...
    def test_model(self):
        self.assert_model_instance(BlogsPageSeo, 'meta_title', self.valid_data["meta_title"])
        self.assert_model_instance(BlogsPageSeo, 'meta_description', self.valid_data["meta_description"])
        self.assert_model_instance(BlogsPageSeo, 'meta_keywords', self.valid_data["meta_keywords"])
        self.assert_model_instance(BlogsPageSeo, 'og_title', self.valid_data["og_title"])
        self.assert_model_instance(BlogsPageSeo, 'og_description', self.valid_data["og_description"])