...
def validate_facebook(value):
    ...
    if not re.match(pattern, value):
        raise ValidationError("Invalid Facebook URL. Please enter a valid Facebook link.")
...
def validate_instagram(value):
    ...
    if not re.match(pattern, value):
        raise ValidationError("Invalid Instagram URL. Please enter a valid Instagram link.")

def validate_linkedin(value):
    pattern = r'^https?://(www\.)?linkedin\.com/.*$'
    if not re.match(pattern, value):
        raise ValidationError("Invalid LinkedIn URL. Please enter a valid LinkedIn link.")
