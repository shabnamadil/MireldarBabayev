...
from apps.core.models.statistics import (
...
class TestStatisticalIndicatorModel(BaseValidationTest):
    ...
    def test_statistical_indicator_png_extension(
        self,
    ):
    ...
    def test_statistical_indicator_value_type(
        self,
    ):
        self.assert_field_type(self.indicator, "value", "a")

    def test_statistical_indicator_name_max_length(
        self,
    ):
        self.assert_max_length(self.indicator, "name", 50)

    def test_statistical_indicator_name_unique(
        self,
    ):
